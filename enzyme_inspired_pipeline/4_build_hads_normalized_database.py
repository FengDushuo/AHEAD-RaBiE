...
def normalize_record(r: Dict[str, Any]) -> Dict[str, Any]:
    ...
    out['qc_has_electronic_descriptor'] = int(any(out.get(k) is not None for k in ['oxidation_state_value','bader_charge','d_band_center','work_function','PZC']) or clean_scalar(out.get('ELF_descriptor')) is not None)
