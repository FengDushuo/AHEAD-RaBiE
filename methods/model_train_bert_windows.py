...
def do_train(input_file,output):
    # Step 1: 数据加载
    ...
    # 加载已保存的模型
    best_bert_model.save_model()

    # 加载已保存的模型
    best_bert_model.load_model()

    # 绘制学习曲线
    plot_learning_curve(best_bert_model, 'BERT_Learning_Curve', output, X_train, y_train)


do_train("D:/a_work/1-phD/project/3-bibliometric/data-sports-injury-medline-26307-20241115/sports-injury-medline-22866-20241115.xlsx","D:/a_work/1-phD/project/3-bibliometric/WOSDataVisualization/methods/bert_output/")