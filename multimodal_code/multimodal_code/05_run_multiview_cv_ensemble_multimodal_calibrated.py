...
def parse_args():
    ...
    ap.add_argument("--calibration-mode", default="affine", choices=["affine", "bias_only"], help="Calibration mapping fitted on validation predictions")
        ...
        for seed in seeds:
            ...
            try:
                ...
                if need_val_preds:
                    ...
                    val_raw_metrics, val_raw_df = evaluate_prediction_frame(val_manifest, pred_obj_val, run_dir / "val_metrics_raw.json")
                    ...
                    if args.use_val_calibration:
                        ...
                        val_cal_metrics, val_cal_df = evaluate_prediction_frame(val_manifest, pred_obj_val_cal, run_dir / "val_metrics_calibrated.json")
